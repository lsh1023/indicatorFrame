...
/**
 * Created by wanxin on 2016-08-13.
 */
public class FeaturedQuestionFragmentAdapter extends BaseQuickAdapter<FeaturedBean.InfosFeaturedBean>{
    public FeaturedQuestionFragmentAdapter(int layoutResId, List<FeaturedBean.InfosFeaturedBean> data) {
