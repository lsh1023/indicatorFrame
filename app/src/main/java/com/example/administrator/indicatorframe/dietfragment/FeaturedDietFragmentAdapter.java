 ...
 */
public class FeaturedDietFragmentAdapter extends BaseQuickAdapter<FeaturedBean.InfosFeaturedBean>{


    public FeaturedDietFragmentAdapter(int layoutResId, List<FeaturedBean.InfosFeaturedBean> data) {
