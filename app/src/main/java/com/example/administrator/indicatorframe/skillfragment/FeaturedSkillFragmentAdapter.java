 ...
 */
public class FeaturedSkillFragmentAdapter extends BaseQuickAdapter<FeaturedBean.InfosFeaturedBean>{
    public FeaturedSkillFragmentAdapter(int layoutResId, List<FeaturedBean.InfosFeaturedBean> data) {
